from finance_complaint.enity.config_enity import (DataIngestionConfig, TrainingPipelineConfig)
from finance_complaint.constant.TrainingPipelineConfig import *
...
class FinanceConfig:
    ...
    def __init__(self, pipeline_name = PIPELINE_NAME, timestamp =TIMESTAMP):
        ...
        def get_data_ingesiton_config(self, from_date = DATA_INGESTION_MIN_START_DATE, to_date= None) \
        -> DataIngestionConfig:
