...
from finance_complaint.entity.metadata_entity import Information_meta
...
class DataIngestion:
    ...
    def write_metadata(self, file_path: str) -> None:
        ...
        try:
            ...
            metadata_info = Information_meta(metadata_file_path=self.data_ingestion_config.metadata_file_path)
